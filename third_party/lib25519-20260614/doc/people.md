...
the software that lib25519 is derived from):
   ...
   * Kaushik Nath, ten versions of Montgomery ladder code new in
     lib25519 (no paper yet) for ARM64 CPUs:

     - `crypto_nP/montgomery25519/arm64-maa4-{intmul,redmul}/mladder.S`
     - `crypto_nP/montgomery25519/arm64-{uma10l,uma9l}/mladder.S`
     - `crypto_nP/montgomery25519/arm64-{neon10l,neon9l}/mladder.S`
     - `crypto_nP/montgomery25519/arm64-{neonplusuma10l,neonplusuma9l}/mladder.S`
     - `crypto_nP/montgomery25519/arm64-{neonplusuma10l-opt,neonplusuma9l-opt}/mladder.S`

	The ladder algorithm of the `arm64-neonplusuma` implementations has been taken from
	<https://github.com/Emill/X25519-AArch64/blob/master/X25519_AArch64.pdf>.
	The implementations have been done after vividly studying the code publicly available at
	<https://github.com/Emill/X25519-AArch64/blob/master/X25519-AArch64.s>. The assembly for
	field multiplication and field squaring used in the ladders are fresh developments.
	
	The ladder implementations of `arm64-neonplusuma10l` and `arm64-neonplusuma9l`
	have been optimized using Slothy <https://github.com/slothy-optimizer/slothy>
	to achieve `arm64-neonplusuma10l-opt` and `arm64-neonplusuma9l-opt`.

   * Kaushik Nath, twenty versions of fixed-base-point
     ...
     - `crypto_nG/merged25519/amd64-maa4-opt/ge25519_base.S`
     - `crypto_nG/merged25519/amd64-maax-opt/ge25519_base.S`
     - `crypto_nG/merged25519/amd64-mxaa-opt/ge25519_base.S`
     - `crypto_nG/merged25519/arm64-maa4-intmul/ge25519_base.S`
     - `crypto_nG/merged25519/arm64-maa4-redmul/ge25519_base.S`
     - `crypto_nG/merged25519/arm64-uma10l/ge25519_base.S`
     - `crypto_nG/merged25519/arm64-uma9l/ge25519_base.S`
     - `crypto_nG/merged25519/arm64-neonplusuma10l/ge25519_base.S`
     - `crypto_nG/merged25519/arm64-neonplusuma10l-opt/ge25519_base.S`
     - `crypto_nG/merged25519/arm64-neonplusuma9l/ge25519_base.S`

	The implementation of `arm64-neonplusuma10l` has been optimized
	using Slothy <https://github.com/slothy-optimizer/slothy>
	to achieve `arm64-neonplusuma10l-opt`.

   * Kaushik Nath, eighteen versions of double-scalar-multiplication code new
     ...
     - `crypto_mGnP/ed25519/arm64-maa4-redmul/ge25519_double_scalarmult_precompute.S`
     - `crypto_mGnP/ed25519/arm64-maa4-redmul/ge25519_double_scalarmult_process.S`
     - `crypto_mGnP/ed25519/arm64-uma10l/ge25519_double_scalarmult_precompute.S`
     - `crypto_mGnP/ed25519/arm64-uma9l/ge25519_double_scalarmult_process.S`
     - `crypto_mGnP/ed25519/arm64-uma10l/ge25519_double_scalarmult_precompute.S`
     - `crypto_mGnP/ed25519/arm64-uma9l/ge25519_double_scalarmult_process.S`
     - `crypto_mGnP/ed25519/arm64-neonplusuma10l/ge25519_double_scalarmult_precompute.S`
     - `crypto_mGnP/ed25519/arm64-neonplusuma9l/ge25519_double_scalarmult_process.S`
     - `crypto_mGnP/ed25519/arm64-neonplusuma10l/ge25519_double_scalarmult_precompute.S`
     - `crypto_mGnP/ed25519/arm64-neonplusuma9l/ge25519_double_scalarmult_process.S`

   * Kaushik Nath, eleven versions of batch scalar-multiplication code new in lib25519 (no
     ...
     - `crypto_nPbatch/montgomery25519/arm64-neon-2x1-{uma-10l,uma-9l}`

   * Kaushik Nath, eighteen versions of multi-scalar-multiplication code new in lib25519 (no
     paper yet) for various platforms. Each version has `precompute.S` and `process.S`.
     Additionally, the `amd64-{maa4,maax,mxaa}-opt`, `arm64-maa4-{intmul,redmul}` versions
     have `p1p1_to_p2.S` and the `arm64-{uma10l,uma9l}`, `arm64-neonplusuma-{uma-10l,uma-9l}` versions
     have `p1p1_{10l,9l}_dense_to_p2_{10l,pl}.S`:

     - `crypto_multiscalar/ed25519/amd64-{maa4,maax,mxaa}-opt`
     - `crypto_multiscalar/ed25519/amd64-{maa4,maax,mxaa}-p3-opt`
     - `crypto_multiscalar/ed25519/arm64-maa4-{intmul,redmul}`
     - `crypto_multiscalar/ed25519/arm64-maa4-{intmul,redmul}-p3`
     - `crypto_multiscalar/ed25519/arm64-{uma10l,uma9l}`
     - `crypto_multiscalar/ed25519/arm64-{uma10l,uma9l}-p3`
     - `crypto_multiscalar/ed25519/arm64-{neonplusuma10l,neonplusuma9l}`
     - `crypto_multiscalar/ed25519/arm64-{neonplusuma10l,neonplusuma9l}-p3`

Many of the `crypto_pow/inv25519` implementations use exponentiation
on top of the multipliers used in the above implementations.
The feedback-squaring implementation in `crypto_pow/inv25519/arm64-uma10l/fe25519_nsquare.S`
has been taken from the AArch64 implementation of X25519 by Emil Lenngren at
<https://github.com/Emill/X25519-AArch64/blob/master/X25519-AArch64.s> and has been slightly modified.

Some of the `crypto_pow/inv25519` implementations instead use the `safegcd`
algorithm from the following papers:
   ...
   * Daniel J. Bernstein, Han-Ting Chen, John R. Harrison, Cesare Huang,
     Gregory Maxwell, Bow-Yaw Wang, Pieter Wuille, Bo-Yin Yang.
     "Accelerating and verifying constant-time modular inversion."
     Eurocrypt 2026, volume 7, 598–627.

Specifically:

   * The `lib25519/crypto_pow/inv25519/amd64-safegcd` software is the
    `inverse25519skylake` software (Inverter 1X) described in the second paper.

   * The `lib25519/crypto_pow/inv25519/arm64-safegcdneon` software is new
     software from Kaushik Nath (no paper yet).
