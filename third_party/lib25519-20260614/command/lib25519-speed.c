...
static void measure_verify_32(void)
{
  ...
  unsigned char *x = (unsigned char *) aligned(xstorage);
  void *ystorage = callocplus(lib25519_verify_32_BYTES);
  unsigned char *y = (unsigned char *) aligned(ystorage);
...
static void measure_pow_inv25519(void)
{
  ...
  unsigned char *n = (unsigned char *) aligned(nstorage);
  void *nestorage = callocplus(lib25519_pow_inv25519_BYTES);
  unsigned char *ne = (unsigned char *) aligned(nestorage);
...
static void measure_nP_montgomery25519(void)
{
  ...
  unsigned char *nP = (unsigned char *) aligned(nPstorage);
...
static void measure_nG_merged25519(void)
{
  ...
  unsigned char *nG = (unsigned char *) aligned(nGstorage);
...
static void measure_mGnP_ed25519(void)
{
  ...
  unsigned char *mGnP = (unsigned char *) aligned(mGnPstorage);
...
static void measure_multiscalar_ed25519(void)
{
  ...
  unsigned char *Q = (unsigned char *) aligned(Qstorage);
...
static void measure_dh_x25519(void)
{
  ...
  unsigned char *pka = (unsigned char *) aligned(pkastorage);
  void *skastorage = callocplus(lib25519_dh_x25519_SECRETKEYBYTES);
  unsigned char *ska = (unsigned char *) aligned(skastorage);
  void *pkbstorage = callocplus(lib25519_dh_x25519_PUBLICKEYBYTES);
  unsigned char *pkb = (unsigned char *) aligned(pkbstorage);
  void *skbstorage = callocplus(lib25519_dh_x25519_SECRETKEYBYTES);
  unsigned char *skb = (unsigned char *) aligned(skbstorage);
  void *kastorage = callocplus(lib25519_dh_x25519_BYTES);
  unsigned char *ka = (unsigned char *) aligned(kastorage);
...
static void measure_sign_ed25519(void)
{
  ...
  unsigned char *pk = (unsigned char *) aligned(pkstorage);
  void *skstorage = callocplus(lib25519_sign_ed25519_SECRETKEYBYTES);
  unsigned char *sk = (unsigned char *) aligned(skstorage);
  ...
  unsigned char *sm = (unsigned char *) aligned(smstorage);
  void *m2storage = callocplus(MAXTEST_BYTES+lib25519_sign_ed25519_BYTES);
  unsigned char *m2 = (unsigned char *) aligned(m2storage);
  long long mlen;
  long long smlen;
  long long m2len;
