...
void declassify(void *x,long long xlen)
{
...
static int (*crypto_verify_32)(const unsigned char *,const unsigned char *);
...
void test_verify_32_impl(long long impl)
{
  ...
  if (targeti && strcmp(targeti,".") && strcmp(targeti,lib25519_dispatch_verify_32_implementation(impl))) return;
  if (targetn && atol(targetn) != impl) return;
  if (impl >= 0) {
    crypto_verify_32 = lib25519_dispatch_verify_32(impl);
    ...
    crypto_verify_32 = lib25519_verify_32;
...
static void test_verify_32(void)
{
  ...
  for (long long offset = 0;offset < 2;++offset) {
    ...
    for (long long impl = -1;impl < lib25519_numimpl_verify_32();++impl)
      forked(test_verify_32_impl,impl);
    ++test_verify_32_x;
    ++test_verify_32_y;
  }
}
