...
void crypto_nG(unsigned char *pk,const unsigned char *sk)
{
  unsigned char e[32];
  sc25519 scsk;
  ge25519_p2_10l_dense gepk;
  fe25519_10l_dense recip;
  fe25519_10l_dense r,s;
  fe25519 x,y;
  int wantmont;
  ...
  fe25519_10l_dense_to_4l(&x,&gepk.z);
  fe25519_invert(&y,&x);
  fe25519_4l_to_10l_dense(&recip,&y);  
  fe25519_mul(&s,&gepk.y,&recip);
  fe25519_mul(&r,&gepk.x,&recip);
  
  fe25519_10l_dense_to_4l(&y,&s);
  fe25519_10l_dense_to_4l(&x,&r);
