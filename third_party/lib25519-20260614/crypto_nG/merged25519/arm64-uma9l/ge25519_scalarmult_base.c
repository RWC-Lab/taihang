...
extern void base(ge25519_p2_9l_dense *,const signed char *,const ge25519_niels_9l_dense *,const int);

void ge25519_scalarmult_base(ge25519_p2_9l_dense *r, const sc25519 *s,const int wantmont)
{
  signed char b[64];
  sc25519_window4(b,s);
