...
static void ge25519_p1p1_0(ge25519_p1p1_9l_dense *r)
{
  fe25519_9l_dense_setint(&r->x,0);
  fe25519_9l_dense_setint(&r->y,1);
  fe25519_9l_dense_setint(&r->z,1);
  fe25519_9l_dense_setint(&r->t,1);
}
...
{
  int ok = 1;
  ge25519_p1p1_9l_dense bigresult;

  ge25519_p1p1_0(&bigresult);

  while (len > 0) {
    signed char nslide[MAXTODO][256];
    ge25519_pniels_9l_dense cP[MAXTODO][P_MULTIPLES]; /* P,3P,5P,7P,9P,11P,13P,15P */
  ...
  {
    ge25519_p2_9l_dense t;

    ge25519_p1p1_9l_dense_to_p2_9l_dense(&t,&bigresult);
    ge25519_9l_dense_pack(Q,&t);
    Q[32] = ok;
  }
}
