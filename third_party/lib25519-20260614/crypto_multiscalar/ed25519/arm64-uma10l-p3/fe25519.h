...
#define fe25519_dummy      CRYPTO_SHARED_NAMESPACE(fe25519_dummy)
...
void fe25519_invert(fe25519_10l_dense *r, const fe25519_10l_dense *x);
...
void  fe25519_dummy(const fe25519 *);
